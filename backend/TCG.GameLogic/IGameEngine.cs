...
public interface IGameEngine
{
    ...
    bool CanPlayCard(GameStateSnapshot state, string playerId, string instanceId, string? targetId);
    GameStateSnapshot PlayCard(GameStateSnapshot state, string playerId, string instanceId, string? targetId);
